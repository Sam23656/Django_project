...
import CreateFramework from '../../api/Framework/CreateFramework';

function AddFrameworkPage() {
  ...
  useEffect(() => {
    ...
    if (!isAdmin && !hasAccessToken) {
      navigate(isModerator ? '/Admin?location=Frameworks' : '/');
    }
  }, []);
  ...
  return (
    <div>
      <div className="d-flex flex-column align-items-center flex-wrap">
        <h1 className="ms-3 me-3">Создать фреймворк</h1>
        <div
...
export default AddFrameworkPage;
